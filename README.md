...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/zU4dBOpQsv)
...
```sh
npx nx serve poll-kendo
```

To create a production bundle:

```sh
npx nx build poll-kendo
```

To see all available targets to run for a project, run:

```sh
npx nx show project poll-kendo
```
